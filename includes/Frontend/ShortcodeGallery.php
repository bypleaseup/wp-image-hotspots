...
<div class="wphs-gallery" id="<?php echo esc_attr($uid); ?>">
	...
	<?php if ( $show_arrows ) : ?>
	<button type="button" class="wphs-gl-arrow wphs-gl-prev" aria-label="<?php echo esc_attr_x( 'Previous', 'gallery navigation', 'wp-image-hotspots' ); ?>" style="position:absolute;top:50%;left:10px;transform:translateY(-50%);background:rgba(0,0,0,.45);border:none;border-radius:50%;width:36px;height:36px;cursor:pointer;display:flex;align-items:center;justify-content:center;color:#fff;z-index:10;padding:0"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M15 18l-6-6 6-6"/></svg></button>
	<button type="button" class="wphs-gl-arrow wphs-gl-next" aria-label="<?php echo esc_attr_x( 'Next', 'gallery navigation', 'wp-image-hotspots' ); ?>" style="position:absolute;top:50%;right:10px;transform:translateY(-50%);background:rgba(0,0,0,.45);border:none;border-radius:50%;width:36px;height:36px;cursor:pointer;display:flex;align-items:center;justify-content:center;color:#fff;z-index:10;padding:0"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 18l6-6-6-6"/></svg></button>
	<?php endif; ?>
	<?php if ( $show_dots ) : ?>
