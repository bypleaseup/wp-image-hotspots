...
distributed on [wordpress.org/plugins/pleaseup-hotspots](https://wordpress.org/plugins/pleaseup-hotspots/).
Internal development happens in a separate, private monorepo;
...
1. **Plugins → Add New**
2. Search for *Pleaseup Hotspots*
3. **Install Now** → **Activate**

To install from a release zip:

1. Download `pleaseup-hotspots-X.Y.Z.zip` from the
...
See the [WordPress.org plugin page](https://wordpress.org/plugins/pleaseup-hotspots/)
...
or the official [WordPress.org support forum](https://wordpress.org/support/plugin/pleaseup-hotspots/).
