...
distributed on [wordpress.org/plugins/wp-image-hotspots](https://wordpress.org/plugins/wp-image-hotspots/).
...
1. **Plugins → Add New**
2. Search for *WP Image Hotspots*
3. **Install Now** → **Activate**

To install from a release zip:

1. Download `wp-image-hotspots-X.Y.Z.zip` from the
...
See the [WordPress.org plugin page](https://wordpress.org/plugins/wp-image-hotspots/)
...
or the official [WordPress.org support forum](https://wordpress.org/support/plugin/wp-image-hotspots/).
